...
class FoxLiGUIJAX(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Fox-Li LASER Cavity Simulator (v2 - JAX)")
    ...
    def save_results(self):
        options = ["Setup Visualisation", "Cavity Simulation", "Simulation Results", "Far-Field analysis", "Results Text", "All"]
...
if __name__ == '__main__':
    ...
    app.setWindowIcon(QIcon(resource_path("icons/app_icon_jax.png")))
    window = FoxLiGUIJAX()
    window.setWindowIcon(QIcon(resource_path("icons/app_icon_jax.png")))
